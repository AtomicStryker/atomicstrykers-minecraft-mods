...
public class FCTransformer implements IClassTransformer
{
     ...
     */
    private String targetNodeDescriptor = "(Lcbh;Lafj;)V";

    /* (Lnet/minecraft/item/ItemStack;)V */
    private String itemStackVoidDescriptor = "(Lafj;)V";
