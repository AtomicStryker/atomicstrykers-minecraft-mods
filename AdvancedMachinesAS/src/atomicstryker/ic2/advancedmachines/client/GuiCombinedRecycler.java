...
public class GuiCombinedRecycler extends GuiContainer
{
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("item.advancedmachines:combinedRecycler.name"), 8, 6, 4210752);
        this.fontRenderer.drawString("Inventory", 8, this.ySize - 96 + 2, 4210752);
        this.fontRenderer.drawString("Mass rate:", 8, 36, 4210752);
