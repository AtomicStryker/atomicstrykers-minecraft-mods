...
public class GuiSingularityCompressor extends GuiContainer
{
    ...
    {
        this.field_146289_q.drawString(StatCollector.translateToLocal("item.advancedmachines:singularityCompressor.name"), 8, 6, 4210752);
        this.field_146289_q.drawString("Inventory", 8, this.ySize - 96 + 2, 4210752);
        this.field_146289_q.drawString("Pressure:", 4, 36, 4210752);
