...
{    
    ...
    public GuiCentrifugeExtractor(ContainerAdvancedMachine<TileEntityStandardMachine> csm, TileEntityAdvancedExtractor te)
    {
        super(csm);
        container = csm;
    }
    ...
    {
        this.fontRendererObj.drawString(StatCollector.translateToLocal("item.advancedmachines:centrifugeExtractor.name"), 8, 6, 4210752);
