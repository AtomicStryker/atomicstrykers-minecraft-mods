...
{    
    ...
    {
        this.field_146289_q.drawString(StatCollector.translateToLocal("item.advancedmachines:centrifugeExtractor.name"), 8, 6, 4210752);
        this.field_146289_q.drawString("Inventory", 8, ySize - 96 + 2, 4210752);
