...
@Mod(modid = "BattleTowers", name = "Battle Towers", version = "1.2.9")
...
public class AS_BattleTowersCore
{
    ...
    {
        configuration.load();
        minDistanceBetweenTowers = Integer.parseInt(configuration.get("MainOptions", "Minimum Distance between 2 BattleTowers", 196).value);
        towerDestroyerEnabled = Integer.parseInt(configuration.get("MainOptions", "Tower Destroying Enabled", 1).value);
        ...
        floorItemManagers[0] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Floor 1", "280-0-75-6-5;295-0-75-3-5;5-0-75-6-5;83-0-75-3-5").value);
        
        // 274-0-25-1-1 stone pick
        // 275-0-25-1-1 stone axe
        // 50-0-75-3-3 torches
        // 77-0-50-2-2 stone button
        floorItemManagers[1] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Floor 2", "274-0-50-1-1;275-0-50-1-1;50-0-80-3-3;77-0-50-2-2").value);
        
        // 281-0-50-2-4 wooden bowl
        // 263-0-75-4-4 coal
        // 287-0-50-5-5 string
        // 35-0-25-2-2 wool
        floorItemManagers[2] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Floor 3", "281-0-75-2-4;263-0-90-4-4;287-0-80-5-5;35-0-75-2-2").value);
        
        // 20-0-50-3-3 glass
        // 288-0-25-4-4 feather
        // 297-0-50-2-2 bread
        // 260-0-75-2-2 apple
        floorItemManagers[3] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Floor 4", "20-0-75-3-3;288-0-75-4-4;297-0-75-2-2;260-0-75-2-2").value);
        
        // 39-0-50-2-2 brown mushroom
        // 40-0-50-2-2 red mushroom
        // 6-0-75-3-3 saplings
        // 296-0-25-4-4 wheat
        floorItemManagers[4] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Floor 5", "39-0-75-2-2;40-0-75-2-2;6-0-90-3-3;296-0-75-4-4").value);
        
        // 323-0-50-1-2 sign
        // 346-0-75-1-1 fishing rod
        // 361-0-25-2-2 pumpkin seeds
        // 362-0-25-3-3 Melon Seeds
        floorItemManagers[5] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Floor 6", "323-0-50-1-2;346-0-75-1-1;361-0-60-2-2;362-0-60-3-3").value);
        ...
        // 351-0-50-1-2 dye
        floorItemManagers[6] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Floor 7", "267-0-60-1-1;289-0-75-3-3;334-0-75-4-4;349-0-75-3-3;351-0-60-1-2").value);
        
        // 302-0-25-1-1 chain helmet
        // 303-0-25-1-1 chain chestplate
        // 304-0-25-1-1 chain leggings
        // 305-0-25-1-1 chain boots
        floorItemManagers[7] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Floor 8", "302-0-40-1-1;303-0-40-1-1;304-0-40-1-1;305-0-40-1-1").value);
        
        // 57-0-50-1-3 bookshelf
        // 123-0-25-2-2 redstone lamp
        // 111-0-75-3-3 Lily Plants
        // 379-0-25-1-1 brewing stand
        floorItemManagers[8] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Floor 9", "57-0-70-1-3;123-0-60-2-2;379-0-75-3-3;379-0-50-1-1").value);
        
        // 368-0-50-2-2 ender pearl
        // 264-0-50-2-2 diamond
        // 331-0-75-5-5 redstone dust
        // 266-0-75-8-8 gold ingot
        floorItemManagers[9] = new TowerStageItemManager(configuration.get("BattleTowerChestItems", "Top Floor", "368-0-50-2-2;264-0-70-2-2;331-0-75-5-5;266-0-90-8-8").value);
