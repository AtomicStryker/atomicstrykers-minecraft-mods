        ...
        if (fadeOutfadeInUnderWay)
        {
            ...
            else if (fadeState == 1)
            {
                ...
                if (incrementingInt >= 180)
                {
                    ...
                    mc.thePlayer.worldObj.playSound(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ,
                            ((EvilDeed) deedButtons.get(actionCalled - 1)).getSoundFile(), 1.0F, 1.0F, false);
