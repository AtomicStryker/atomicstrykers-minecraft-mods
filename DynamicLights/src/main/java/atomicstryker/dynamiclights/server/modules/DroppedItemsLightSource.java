...
public class DroppedItemsLightSource {
    ...
    private class EntityItemAdapter implements IDynamicLightSource {
        ...
        public EntityItemAdapter(ItemEntity eI) {
            ...
            enabled = false;
            entity = eI;
            notWaterProof = notWaterProofItems.getLightLevel(eI.getItem(), eI.registryAccess()) > 0 || eI.getItem().tags().anyMatch(rl -> rl.location().equals(DynamicLights.NOT_WATERPROOF_TAG));
        }
